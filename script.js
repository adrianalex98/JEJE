...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = 'COMO TE AMOOOOO';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 5:
            ...
            document.getElementById('noBtn').innerHTML = 'Solo piensa en ello por favor';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 10:
            ...
            document.getElementById('noBtn').innerHTML = 'TA BIEN, ya dejaré de preguntar...';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 11:
            ...
            document.getElementById('noBtn').innerHTML = 'Puro pedo, POR FAVOR DI SÍ';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
